...
class CarreiraProfissionalSeeder extends Seeder
{
    public function run()
    {
        ...
        TbCarreiraProfissional::create([
            ...
            'dt_final' => null,
            'st_trabalho_atual' => 1,
            'ds_formacao' => '- Manutenção e desenvolvimento de sistemas utilizando framework, back-end, PHP Laravel; 
                - Manutenção e desenvolvimento com framework, front-end, Angular;
                - Atendimento de chamados de Sustentações de sistemas; 
            ',
            'nr_total_horas' => null,
            'ds_url' => null
        ]);
        ...
        TbCarreiraProfissional::create([
            ...
            'no_experiencia' => 'ChatGPT para Desenvolvedores',
            'no_empresa' => 'Udemy',
            ...
            'ds_formacao' => null,
            'nr_total_horas' => 3.5,
            'ds_url' => 'https://www.udemy.com/certificate/UC-ce676e21-ba74-4eca-899c-6390eedea16e/'
        ]);
