...
function iknow_tm_contact_form(){
	...
	jQuery(".contact_form #send_message").off().on('click', function(){
		...
		var name 		= jQuery(".contact_form #no_contato").val();
		var email 		= jQuery(".contact_form #ds_email").val();
		var message 	= jQuery(".contact_form #ds_mensagem").val();
		var subject 	= jQuery(".contact_form #ds_assunto").val();
