...
@endif
    ...
    <div class="mb-3 col-md-6">
        <div class="card text-center" style="width: 18rem;">
            <img src="{{ isset($dadoServico->ds_url_icon_svg) ? asset_path("storage/$dadoServico->ds_url_icon_svg") : asset_path('default/default-icon.svg') }}" class="card-img-top img-proporcao-icon" alt="Icone de Serviço">
            <div class="card-body">
