            ...
            <ul>
                ...
                <li>
                    <div class="list_inner">
                        <span class="icon"><img class="svg" src="{{ asset('template-internauta/img/svg/') }}{{ $dadoServico->ds_url_icon_svg }}" alt="" /></span>
                        ...
                        <div class="hidden_content">
                            <div class="service_informations">
                                <div class="image">
                                    ...
                                    <div class="main" data-img-url="{{ asset('template-internauta/img/service/') }}{{ $dadoServico->ds_url_img }}"></div>
                                </div>
