...
<body class="dark">
	...
	<!-- WRAPPER ALL -->
	{{-- <div class="iknow_tm_all_wrap" data-magic-cursor="show" data-enter="jello" data-exit=""> --}}
	<div class="iknow_tm_all_wrap" data-magic-cursor="show" data-animation-in="rotateInDownLeft" data-animation-out="rotateOutDownLeft">
		<!-- If you want disable magic cursor change value to "hide" or "show" -->
		...
		<div class="iknow_tm_mobile_menu">
			<div class="mobile_menu_inner">
				<div class="mobile_in">
					<div class="logo">
						<a href="#"><img src="{{ asset('template-internauta/img/') }}/logo/light.png" alt="" /></a>
					</div>
					<div class="trigger">
		...
		<!-- SIDEBAR -->
		<div class="iknow_tm_sidebar_2">
			<div class="sidebar_inner">
				<div class="logo">
					<a href="#"><img src="{{ asset('template-internauta/img/') }}/logo/light.png" alt="" /></a>
				</div>
				<div class="menu transition_link">
					<ul>
						<li class="active">
							<img class="svg" src="{{ asset('template-internauta/img/') }}/svg/squares.svg" alt="" />
							<span>Home</span>
							<a class="iknow_tm_full_link" href="#home"></a>
						</li>
						<li>
							<img class="svg" src="{{ asset('template-internauta/img/') }}/svg/archive.svg" alt="" />
							<span>About Me</span>
		...
		<!-- MAINPART -->
		<div class="iknow_tm_fixed_mainpart">
			<div class="mainpart_inner">

				<!-- Hero Shapes -->
				<div class="simple_shapes">
					<span class="one anim_scale"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/shapes/9.svg" alt="" /></span>
					<span class="two anim_moveLeft"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/shapes/dot.svg" alt="" /></span>
					<span class="three anim_moveTop"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/shapes/dot-2.svg" alt="" /></span>
					<span class="four anim_circle"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/shapes/1.svg" alt="" /></span>
					<span class="five anim_circle"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/shapes/8.svg" alt="" /></span>
					<span class="six anim_circle"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/shapes/3.svg" alt="" /></span>
					<span class="seven anim_right"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/shapes/4.svg" alt="" /></span>
					<span class="eight anim_scale"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/shapes/9.svg" alt="" /></span>
					<span class="nine anim_circle"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/shapes/3.svg" alt="" /></span>
					<span class="ten anim_moveLeft"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/shapes/4.svg" alt="" /></span>
					<span class="eleven anim_scale"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/shapes/9.svg" alt="" /></span>
					<span class="twelve anim_extra"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/shapes/2.svg" alt="" /></span>
					<span class="thirteen anim_circle"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/shapes/5.svg" alt="" /></span>
					<span class="fourteen anim_scale"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/shapes/9.svg" alt="" /></span>
					<span class="fifteen anim_circle"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/shapes/3.svg" alt="" /></span>
					<span class="sixteen anim_scale"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/shapes/9.svg" alt="" /></span>
					<span class="seventeen anim_circle"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/shapes/5.svg" alt="" /></span>
					<span class="eighteen anim_scale"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/shapes/9.svg" alt="" /></span>
					<span class="nineteen anim_scale"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/shapes/9.svg" alt="" /></span>
					<span class="twenty anim_circle"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/shapes/1.svg" alt="" /></span>
				</div>
				<!-- /Hero Shapes -->
				...
				<div class="topbar_extra">
					<div class="details">
						<div class="social">
							<ul>
								<li><a href="#"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/social/facebook.svg" alt="" /></a></li>
								<li><a href="#"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/social/twitter.svg" alt="" /></a></li>
								<li><a href="#"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/social/youtube.svg" alt="" /></a></li>
								<li><a href="#"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/social/instagram.svg" alt="" /></a></li>
							</ul>
						</div>
						<div class="iknow_tm_button">
							<a href="{{ asset('template-internauta/img/') }}/cv/1.jpg" download>Download CV</a>
						</div>
					</div>
				</div>
				<!-- /TOPBAR -->
				...
				<!-- CONTENT -->
				<div class="iknow_tm_content_extra">

					<!-- HOME -->
					<div class="iknow_tm_animate_section animated" id="home">
						<div class="iknow_tm_hero_extra">
							...
							<div class="hero_content">
								...
								<div class="right">
									<div class="image parallax" data-relative-input="true">
										...
										<div class="main layer" data-depth="0.05" data-img-url="{{ asset('template-internauta/img/') }}/hero/7.jpg"></div>
										<span class="box layer" data-depth="0.1"></span>
									</div>
								</div>
							</div>
						</div>
					...
					<!-- ABOUT -->
					<div class="iknow_tm_animate_section" id="about">
						<div class="section_inner">
							<div class="iknow_tm_about">
								<div class="left">
									<div class="left_inner">
										<div class="image">
											...
											<div class="main" data-img-url="{{ asset('template-internauta/img/') }}/hero/7.jpg"></div>
										</div>
										<div class="details">
											<ul>
												<li>
													<h3>Name</h3>
													<span>Jassone Doe</span>
												</li>
												<li>
													<h3>Birthday</h3>
								...
								<div class="right">
									...
									<div class="text">
										<p>Hi! My name is Jassone Doe. I am UI/UX designer, and I'm very passionate and
					...
					<!-- RESUME -->
					<div class="iknow_tm_animate_section" id="resume">
						<div class="section_inner">
											...
											<ul>
												<li>
													<div class="list_inner">
														...
														<div class="text">
															<p>The goal of cognitive science is to understand the
																principles of intelligence with the hope that this will
																lead to better comprehension.</p>
														</div>
													</div>
												</li>
												<li>
													<div class="list_inner">
														...
														<div class="text">
															<p>Civil engineering is arguably the oldest engineering
																discipline. It deals with the built environment and can
																be dated to the first time someone placed a roof.</p>
														</div>
													</div>
												</li>
												<li>
													<div class="list_inner">
														...
														<div class="text">
															<p>This project is called a thesis and is usually presented
																in front of a group of people, including university
											...
											<ul>
												<li>
													<div class="list_inner">
														...
														<div class="text">
															<p>Web Developers are build a website’s core structure using
																coding languages, while designers are more visually
																creative and user-focused.</p>
														</div>
													</div>
												</li>
												<li>
					...
					<!-- PORTFOLIO -->
					<div class="iknow_tm_animate_section" id="portfolio">
						<div class="section_inner">
									...
									<ul class="gallery_zoom">
										<li class="vimeo">
											<div class="list_inner">
												...
												<div class="overlay"></div>
												<img class="svg" src="{{ asset('template-internauta/img/') }}/svg/social/vimeo.svg" alt="" />
												<div class="details">
													<span>Vimeo</span>
													<h3>Aumeo Audio</h3>
												</div>
										...
										<li class="youtube">
											<div class="list_inner">
												...
												<div class="overlay"></div>
												<img class="svg" src="{{ asset('template-internauta/img/') }}/svg/social/youtube-2.svg" alt="" />
												<div class="details">
													<span>Youtube</span>
													<h3>Bicker &amp; Jenna</h3>
												</div>
										...
										<li class="soundcloud">
											<div class="list_inner">
												...
												<div class="overlay"></div>
												<img class="svg" src="{{ asset('template-internauta/img/') }}/svg/social/soundcloud.svg" alt="" />
												<div class="details">
										...
										<li class="youtube">
											<div class="list_inner">
												<div class="image">
													<img src="{{ asset('template-internauta/img/') }}/thumbs/1-1.jpg" alt="" />
													<div class="main" data-img-url="{{ asset('template-internauta/img/') }}/portfolio/6.jpg"></div>
												</div>
												<div class="overlay"></div>
												<img class="svg" src="{{ asset('template-internauta/img/') }}/svg/social/youtube-2.svg" alt="" />
												<div class="details">
										...
										<li class="vimeo">
											<div class="list_inner">
												<div class="image">
													<img src="{{ asset('template-internauta/img/') }}/thumbs/1-1.jpg" alt="" />
													<div class="main" data-img-url="{{ asset('template-internauta/img/') }}/portfolio/7.jpg"></div>
												</div>
												<div class="overlay"></div>
												<img class="svg" src="{{ asset('template-internauta/img/') }}/svg/social/vimeo.svg" alt="" />
												<div class="details">
										...
										<li class="detail">
											<div class="list_inner">
												...
												<div class="overlay"></div>
												<img class="svg" src="{{ asset('template-internauta/img/') }}/svg/text.svg" alt="" />
												<div class="details">
													<span>Detail</span>
													<h3>Teresa Melbig</h3>
												</div>
														...
														<div class="main_details">
															<div class="textbox">
																...
																<p>Mockups are useful both for the creative phase of the
																	...
																	and the production phase when they will represent
																	the target product.</p>
															</div>
															<div class="detailbox">
																<ul>
																	<li>
																	...
																	<li>
																		...
																		<ul class="share">
																			<li><a href="#"><img class="svg"
																						src="{{ asset('template-internauta/img/') }}/svg/social/facebook.svg"
																						alt="" /></a></li>
																			<li><a href="#"><img class="svg"
																						src="{{ asset('template-internauta/img/') }}/svg/social/twitter.svg"
																						alt="" /></a></li>
																			<li><a href="#"><img class="svg"
																						src="{{ asset('template-internauta/img/') }}/svg/social/instagram.svg"
																						alt="" /></a>
																			</li>
																		</ul>
																	</li>
																...
																<li>
																	<div class="list_inner">
																		<div class="my_image">
																			...
																			<div class="main"
																				data-img-url="{{ asset('template-internauta/img/') }}/portfolio/1.jpg">
																			</div>
																		</div>
																	</div>
																</li>
																<li>
																	<div class="list_inner">
																		<div class="my_image">
																			<img src="{{ asset('template-internauta/img/') }}/thumbs/4-2.jpg" alt="" />
																			<div class="main"
																				data-img-url="{{ asset('template-internauta/img/') }}/portfolio/2.jpg">
																			</div>
																		</div>
																	</div>
																</li>
																<li>
																	<div class="list_inner">
																		<div class="my_image">
																			<img src="{{ asset('template-internauta/img/') }}/thumbs/4-2.jpg" alt="" />
																			<div class="main"
																				data-img-url="{{ asset('template-internauta/img/') }}/portfolio/3.jpg">
																			</div>
																		</div>
																	</div>
																</li>
					...
					<!-- SERVICE -->
					<div class="iknow_tm_animate_section" id="service">
						<div class="section_inner">
							<div class="iknow_tm_services">
								...
								<div class="service_list">
									<ul>
										<li>
											<div class="list_inner">
												<span class="icon"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/squares.svg"
														alt="" /></span>
												<h3 class="title">Wireframing</h3>
												<p class="text">Web development is the building and maintenance of
													websites. it’s the work that...</p>
												...
												<div class="hidden_content">
													<div class="service_informations">
														...
														<div class="description">
															<p>iKnow is a leading web design agency with an
										...
										<li>
											<div class="list_inner">
												<span class="icon"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/physics.svg"
														alt="" /></span>
										...
										<li>
											<div class="list_inner">
												<span class="icon"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/web.svg"
														alt="" /></span>
										...
										<li>
											<div class="list_inner">
												<span class="icon"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/user.svg"
														alt="" /></span>
										...
										<li>
											<div class="list_inner">
												<span class="icon"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/briefcase.svg"
														alt="" /></span>
										...
										<li>
											<div class="list_inner">
												<span class="icon"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/writing_2.svg"
														alt="" /></span>
					...
					<!-- TESTIMONIALS -->
					<div class="iknow_tm_animate_section" id="testimonials">
						<div class="section_inner">
							<div class="iknow_tm_testimonials">
								...
								<div class="testimonials_list owl-carousel owl-theme">
										...
										<div class="in">
											<div class="text">
												<p>These people really know what they are doing! Great customer support
													availability and supperb kindness. I am very happy that I've
													purchased this liscense!!!</p>
											</div>
											<div class="details">
												<div class="left">
													<div class="avatar">
									...
									<div class="list_inner">
										<div class="in">
											<div class="text">
												<p>The design is elegant. The customer support on this product is also
													amazing. I would highly recommend you to purchase templates from the
													Marketify team!</p>
											</div>
											<div class="details">
												<div class="left">
									...
									<div class="list_inner">
										<div class="in">
											<div class="text">
												<p>The Author had done a great job, it's clean and easy to understand
													the code. Comment blocks made it really easy to read the code.</p>
											</div>
											<div class="details">
												<div class="left">
													<div class="avatar">
									...
									<div class="list_inner">
										<div class="in">
											<div class="text">
												<p>I can't believe I got support and my problem resolved in minutes from
													posting my question. Simply amazing team and amazing theme! Thank
													you!</p>
											</div>
											<div class="details">
												<div class="left">
					...
					<!-- NEWS -->
					<div class="iknow_tm_animate_section" id="news">
						<div class="section_inner">
					...
					<!-- CONTACT -->
					<div class="iknow_tm_animate_section" id="contact">
						<div class="section_inner">
								...
								<div class="wrapper">
									<div class="left">
										<ul>
											<li>
												<div class="list_inner">
													<span class="icon"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/smartphone.svg"
															alt="" /></span>
													<div class="short">
														<h3>Call Me</h3>
														<span>+123 456 7890</span>
											...
											<li>
												<div class="list_inner">
													<span class="icon"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/letter.svg"
															alt="" /></span>
													<div class="short">
														<h3>Email Us</h3>
											...
											<li>
												<div class="list_inner">
													<span class="icon"><img class="svg" src="{{ asset('template-internauta/img/') }}/svg/placeholder.svg"
															alt="" /></span>
													<div class="short">
														<h3>Address</h3>
				...
				<!-- COPYRIGHT -->
				<div class="extra_copyright">
					<div class="iknow_tm_copyright">
						<div class="inner">
							<div class="left">
								<p>Designed with love &copy; <a href="https://themeforest.net/user/marketify"
										target="_blank">Marketify</a></p>
							</div>
							<div class="right">
								<ul>
